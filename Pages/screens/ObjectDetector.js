...
const MODEL_URL =
  'https://github.com/SMpanacea/FrontEnd/raw/visionCamera_yolov5-integration/yolov5Model/best.pt';
...
//     const assetsPath = 'best.ptl';
//     const documentDirectoryPath = RNFS.DocumentDirectoryPath;
//     const appDirectoryPath = documentDirectoryPath.replace('/files', '');
//     const customDirectory = appDirectoryPath + '/cache/facebookresearch/playtorch/releases/download/v0.2.0';
//     const filePath = customDirectory + '/best.ptl';
//     console.log('filePath',filePath)
//     // Copy the file from assets to the custom directory
//     try {
//       await RNFS.copyFileAssets(assetsPath, filePath);
//       console.log('Model file successfully copied to the custom directory.');
//     } catch (error) {
//       console.error('Failed to copy the model file to the custom directory:', error);
//     }
